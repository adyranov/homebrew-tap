...
class LlamaCpp < Formula
  ...
  if Hardware::CPU.arm?
    url "https://github.com/adyranov/ggml-metal-dist/releases/download/v26.7.0/llama-cpp-v26.6.2-arm64-apple-darwin.tar.gz"
    sha256 "7289dfd5fd0efb08c551b38792b7af3d799af80d6342707ca30a665bfae342fd"
  else
    url "https://github.com/adyranov/ggml-metal-dist/releases/download/v26.7.0/llama-cpp-v26.6.2-x86_64-apple-darwin.tar.gz"
